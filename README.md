...
**Manual.** Create a release through GH UI to trigger deployment of a new npm `@myevaluations/plasmic-utils` package version, which will be named after the release name.
